<template>
    <view class="form">
          <uni-forms class="formDetail" ref="form" :modelValue="formData" :rules="rules">
            <uniSection title="报告信息" type="line"/>
            <uni-forms-item label="报告名称">
                <uni-easyinput :inputBorder="false" v-model="report.name" type="text" disabled/>
            </uni-forms-item>
             <uni-forms-item label="调研时间">
               <uni-easyinput :inputBorder="false" v-model="report.reportDate" type="text" disabled/>
            </uni-forms-item>
             <uni-forms-item label="报告类型">
                <uni-easyinput :inputBorder="false" v-model="report.researchTypeDesc" type="text" disabled/>
            </uni-forms-item>
              <uni-forms-item label="公开方式">
                <uni-easyinput v-if="report.openType == '0'" :inputBorder="false" value="公开" type="text" disabled/>
                <uni-easyinput v-if="report.openType == '1'" :inputBorder="false" value="非公开" type="text" disabled/>
            </uni-forms-item>
