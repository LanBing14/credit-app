<template>
    <view class="cardList">
        <view class="li" v-for="(item,index) in cardsList" :key="index">
            <navigator :url="`/pages/creditCardDetail/index?companyId=${item.COMPANY_ID}&companyName=${item.COMPANY_NAME}`" hover-class="none" class="liTop">
                ...
                <view class="liTopMain">
                    ...
                    <view class="liTopList">
                        <text v-if="item.companyInfo">统一社会信用代码：{{item.companyInfo.creditCode ? item.companyInfo.creditCode : '-'}}</text>
            ...
            <view class="liBtm clear">
                <navigator :url="`/pages/creditCardCerti/index?companyId=${item.COMPANY_ID}&companyName=${item.COMPANY_NAME}`" hover-class="none" class="li">入驻证书</navigator>
                <navigator :url="`/pages/creditCardCommit/index?companyId=${item.COMPANY_ID}&companyName=${item.COMPANY_NAME}`" hover-class="none" class="li">入驻承诺书</navigator>
                <navigator :url="`/pages/creditCardInfo/index?companyId=${item.COMPANY_ID}`" hover-class="none" class="li">基本详情</navigator>
            </view>
        </view>
